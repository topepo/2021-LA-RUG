...
The preprocessor might be a simple formula or a sophisticated recipes.  
...
bad <- fit(reg_model, chicago_train)
...
---
# Bonus: Create an ensemble via stacking
...
If the loss of performance is good, it implies that the predictor was important. 
]
